...
int
#if defined(MODIFY_FUNCTION_DEFINED)
f_to_fraction(double d, double	*numeratorp, double	*denominatorp)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
make_fractions(token_type	*equation,int		* np)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
make_simple_fractions(token_type	*equation, int		*np)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
make_mixed_fractions(token_type	*equation, int		*np)
#else
