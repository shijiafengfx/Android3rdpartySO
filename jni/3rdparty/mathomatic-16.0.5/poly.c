...
vcmp(sort_type	*p1, sort_type	*p2)
#else
vcmp(p1, p2)
sort_type	*p1, *p2;
#endif
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly_in_v_sub(token_type	*p1,int n,long v,int allow_divides)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly_in_v(token_type	*p1,int n,long v,int allow_divides)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly_factor(token_type	*equation, int		*np,int do_repeat)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
pf_sub(token_type	*equation, int		*np,int loc,int len,int level,int do_repeat)
#else
...
#endif
#ifdef USE_EXTERN_STRING
		debug_string(2, "Resulting factors of pf_sub():");
		side_debug(2, &equation[loc], i - loc);
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly_gcd(token_type	*larger,int llen, token_type	*smaller,int slen,long v)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly2_gcd(token_type	*larger,int llen, token_type	*smaller,int slen, long v,int require_additive)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
is_integer_expr(token_type	*p1,int n)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
mod_simp(token_type	*equation, int		*np)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
div_remainder(token_type	*equation,int		* np,int poly_flag,int quick_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
poly_div(token_type	*d1,int len1, token_type	*d2, int len2, long		*vp)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
smart_div(token_type	*d1, int len1, token_type	*d2, int len2)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
find_highest_count(token_type	*p1,int n1, token_type	*p2,int n2, long		*vp1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
find_greatest_power(token_type	*p1,int n1, long		*vp1, double		*pp1, int		*tp1, int		*lentp1, int		*dcodep)
#else
