...
char *
#if defined(MODIFY_FUNCTION_DEFINED)
parse_section(token_type	*equation, int		*np, char		*cp, int allow_space)
#else
...
char *
#if defined(MODIFY_FUNCTION_DEFINED)
parse_expr(token_type	*equation, int		*np, char		*cp,int allow_space)
#else
