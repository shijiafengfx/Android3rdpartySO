...
int
#if defined(MODIFY_FUNCTION_DEFINED)
factor_plus(token_type	*equation, int		*np, long v, double d)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
fplus_recurse(token_type	*equation, int		*np, int loc, int level, long v, double d,int whole_flag,int div_only)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
fplus_sub(token_type	*equation, int		*np, int loc, int i1, int n1, int i2, int n2, int level, long v, double d, int whole_flag, int div_only)
#else
