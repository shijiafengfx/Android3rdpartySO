...
void
#if defined(MODIFY_FUNCTION_DEFINED)
default_color(int set_no_color_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list1_sub(int n, int export_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list_proc(token_type	*p1, int n, int export_flag)
#else
...
char *
#if defined(MODIFY_FUNCTION_DEFINED)
list_equation(int n, int export_flag)
#else
...
char *
#if defined(MODIFY_FUNCTION_DEFINED)
list_expression(token_type	*p1, int n, int export_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list_string(token_type	* p1,int n, char		*string,int export_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list_string_sub(token_type	*p1,int n,int outflag, char		*string,int export_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list_code_equation(int en, enum language_list language,int int_flag)
#else
...
char *
#if defined(MODIFY_FUNCTION_DEFINED)
string_code_equation(int en,enum language_list language,int int_flag)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
list_code(token_type		*equation, int			*np,int outflag, char			*string,enum language_list language,int int_flag)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
flist_sub(token_type	*p1,int n,int out_flag, char		*string,int sbuffer_size,int pos,int *highp,int *lowp)
#else
...
static int
#if defined(MODIFY_FUNCTION_DEFINED)
flist_recurse(token_type	*p1,int n,int out_flag, char		*string,int sbuffer_size,int line,int pos,int cur_level,int* highp,int* lowp)
#else
