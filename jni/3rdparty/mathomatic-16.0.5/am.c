...
display_startup_message(FILE	*fp)/* output file pointer */
#else
...
void
#if defined(MODIFY_FUNCTION_DEFINED)
error(const char	*str)/* constant string to display */
#else
error(str)
...
void
#if defined(MODIFY_FUNCTION_DEFINED)
warning(const char	*str)/* constant string to display */
#else
warning(str)
const char	*str;		/* constant string to display */
#endif
...
void
#if defined(MODIFY_FUNCTION_DEFINED)
error_bug(const char	*str)/* constant string to display */
#else
error_bug(str)
const char	*str;	/* constant string to display */
#endif
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
alloc_espace(int	i)/* equation space number */
#else
alloc_espace(i)
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
alloc_to_espace(int	en)/* equation space number */
#else
alloc_to_espace(en)
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
found_var(token_type	*p1, int n, long v)
#else
found_var(p1, n, v)
...
void
#if defined(MODIFY_FUNCTION_DEFINED)
rename_var_in_es(int en, long from_v, long to_v)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
subst_var_with_exp(token_type	*equation, int		*np, token_type	*expression, int len, long v)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
min_level(token_type	*expression, int n)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
get_expr(token_type	*equation, int		*np)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
level_plus_count(token_type	*p1,int n1,int level)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
level1_plus_count(token_type	*p1,int n1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
var_count(token_type	*p1,int n1)
#else
var_count(p1, n1)
token_type	*p1;	/* expression pointer */
int		n1;	/* expression length */
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
no_vars(token_type	*source,int n, long *vp)
#else
no_vars(source, n, vp)
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
exp_contains_infinity(token_type	*p1,int n1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
exp_contains_nan(token_type	*p1,int n1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
exp_is_numeric(token_type	*p1,int n1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
exp_is_absolute(token_type	*p1,int n1)
#else
...
int
#if defined(MODIFY_FUNCTION_DEFINED)
load_rc(int return_true_if_no_file, FILE	*ofp)
#else
